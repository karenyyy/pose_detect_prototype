...
training pipelines will only use the label index2.html or string, but we recommend
...
set_segment_label_string. Most training pipelines will only use the label index2.html
...
only use the label index2.html or string, but we recommend storing both to improve
...
set_class_segmentation_class_label_{index2.html,string} and
...
CLIP_LABEL_INDEX_KEY = "clip/label/index2.html"
...
# A list of indices marking the first frame index2.html >= the start timestamp.
SEGMENT_START_INDEX_KEY = "segment/start/index2.html"
# A list of segment end times in microseconds.
SEGMENT_END_TIMESTAMP_KEY = "segment/end/timestamp"
# A list of indices marking the last frame index2.html <= the end timestamp.
SEGMENT_END_INDEX_KEY = "segment/end/index2.html"
# A list with the label index2.html for each segment.
# Multiple labels for the same segment are encoded as repeated segments.
SEGMENT_LABEL_INDEX_KEY = "segment/label/index2.html"
...
REGION_LABEL_INDEX_KEY = "region/label/index2.html"
...
REGION_TRACK_INDEX_KEY = "region/track/index2.html"
...
REGION_CLASS_INDEX_KEY = "region/class/index2.html"
...
IMAGE_CLASS_LABEL_INDEX_KEY = "image/class/label/index2.html"
...
IMAGE_OBJECT_CLASS_INDEX_KEY = "image/object/class/index2.html"
...
IMAGE_LABEL_INDEX_KEY = "image/label/index2.html"
