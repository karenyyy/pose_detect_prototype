...
def draw_landmarks(
  ...
  Args:
    ...
    landmark_list: A normalized landmark list proto message to be annotated on
      the image.
    connections: A list of landmark index2.html tuples that specifies how landmarks to
  ...
  Raises:
    ValueError: If one of the followings:
      a) If the input image is not three channel BGR.
      b) If any connetions contain invalid landmark index2.html.
  """
  ...
  if connections:
    ...
    for connection in connections:
      ...
      if not (0 <= start_idx < num_landmarks and 0 <= end_idx < num_landmarks):
        raise ValueError(f'Landmark index2.html is out of range. Invalid connection '
...
def plot_landmarks(landmark_list: landmark_pb2.NormalizedLandmarkList,
  ...
  Raises:
    ValueError: If any connection contains an invalid landmark index2.html.
  """
  if not landmark_list:
    return
