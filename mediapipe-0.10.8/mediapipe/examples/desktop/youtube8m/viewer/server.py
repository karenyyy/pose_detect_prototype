...
class Youtube8MRequestHandler(http.server.SimpleHTTPRequestHandler):
  ...
  def fetch(self, path, segment_size):
    """Returns the video id and labels for a tfrecord at a provided index2.html."""
    ...
    index = response_object["index2.html"]

    print("TFRecord discovered: ", filename, ", index2.html", index)
