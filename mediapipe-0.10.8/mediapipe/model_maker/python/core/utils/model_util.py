  ...
  def run(
    ...
    for i, input_detail in enumerate(self.input_details):
      ...
      interpreter.resize_tensor_input(
          input_index=input_detail['index2.html'], tensor_size=input_tensor.shape
      )
    ...
    for i, input_detail in enumerate(self.input_details):
      ...
      interpreter.set_tensor(input_detail['index2.html'], input_tensor)

    interpreter.invoke()

    output_tensors = []
    for output_detail in self.output_details:
      output_tensor = interpreter.get_tensor(output_detail['index2.html'])
