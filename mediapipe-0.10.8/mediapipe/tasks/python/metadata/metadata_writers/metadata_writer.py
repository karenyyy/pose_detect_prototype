...
class CalibrationParameter:
  ...
  For each index2.html in the output tensor, this applies:
  ...
  def create_from_file(cls,
    ...
    Args:
      ...
      file_path: file_path of the score calibration file [1]. Contains
        ...
        contain for each index2.html of an output tensor the scale, slope, offset and
        ...
        scores for this index2.html to default_score. In summary, each line should
