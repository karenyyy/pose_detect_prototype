...
class ImageSegmenter(base_vision_task_api.BaseVisionTaskApi):
  ...
  def labels(self) -> List[str]:
    ...
    For CATEGORY_MASK type, the index2.html in the category mask corresponds to the
    category in the label list.
    For CONFIDENCE_MASK type, the output mask list at index2.html corresponds to the
    category in the label list.
